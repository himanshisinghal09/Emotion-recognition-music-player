...
while True:
    ...
    if time.time() > future:##after 20second music will play
        try:
            ...
            mp = '/usr/bin/rhythmbox'
            if text == 'Angry':
                randomfile = random.choice(os.listdir("/home/himanshi/Documents/Music/Songs/Angry"))
                print('You are angry !!!! please calm down:) ,I will play song for you :' + randomfile)
                file = ('/home/himanshi/Documents/Music/Songs/Angry/' + randomfile)
                subprocess.call([mp, file])

            if text == 'Smile':
                randomfile = random.choice(os.listdir("/home/himanshi/Documents/Music/Songs/Smile/"))
                print('You are smiling :) ,I playing special song for you: ' + randomfile)
                file = ('/home/himanshi/Documents/Music/Songs/Smile/' + randomfile)
                subprocess.call([mp, file])

            if text == 'Fear':
                randomfile = random.choice(os.listdir("/home/himanshi/Documents/Music/Songs/Fear/"))
                print('You have fear of something ,I playing song for you: ' + randomfile)
                file = ('/home/himanshi/Documents/Music/Songs/Fear/' + randomfile)
                subprocess.call([mp, file])

            if text == 'Sad':
                randomfile = random.choice(os.listdir("/home/himanshi/Documents/Music/Songs/Sad/"))
                print('You are sad,dont worry:) ,I playing song for you: ' + randomfile)
                file = ('/home/himanshi/Documents/Music/Songs/Sad/' + randomfile)
                subprocess.call([mp, file])
            break
